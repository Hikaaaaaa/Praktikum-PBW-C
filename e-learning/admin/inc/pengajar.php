...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading"><a href="?page=pengajar&action=tambah" class="btn btn-primary btn-sm">Tambah Data</a></div>
	        ...
	        <div class="panel panel-default">
	            ...
	            <div class="panel-body">
					<form method="post" action="?page=pengajar&action=prosestambah" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" name="email" class="form-control" placeholder="Ex. andar@gmail.com" />
                        </div>
                        <div class="form-group">
                            <label>Alamat *</label>
                        ...
                        <div class="form-group">
                            <label>Website</label>
                            <input type="url" name="web" class="form-control" placeholder="Ex. http://andar.blogspot.com" />
                        </div>
                        <div class="form-group">
