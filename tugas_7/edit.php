...
<html lang="en" dir="ltr">
  ...
  <body>
<div>
  <form class="modal-content animate-modal" action="prosesedit.php" method="POST">
    ...
    <div class="container-modal">
      ...
      <input type="text" placeholder="level" name="level" value="<?php echo $data['level'] ?>" required>
